...
<c:choose> 
  ...
  <div class="btn-group-vertical">
      ...
      <a href='../product/ranking' class="btn btn-light">오늘의 술</a>
      <a href='../product/list' class="btn btn-light">상품</a>
      <a href='../product/review/find' class="btn btn-light">내가남긴<br>리뷰</a>
      ...
      <a href='../buyer/detail?id=${loginUser.id}' class="btn btn-light">개인정보<br>변경</a>
  </div>
  </c:when>
  ...
  <div class="btn-group-vertical">
      ...
      <a href='../message/list' class="btn btn-light">메세지</a>
      <a href='../seller/detail?id=${loginUser.id}' class="btn btn-light">개인정보<br>변경</a>
  </div>
  </c:when>
  ...
  <div class="btn-group-vertical">
      ...
      <a href='../product/ranking' class="btn btn-light">오늘의 술</a>
      <a href='../product/list' class="btn btn-light">상품</a>
      <a href='../buyer/list' class="btn btn-light">회원(구매자)<br>관리</a>
      <a href='../seller/list' class="btn btn-light">회원(판매자)<br>관리</a>
      <a href='../message/list' class="btn btn-light">메세지</a>
  </div>
  </c:when>
</c:choose> 
