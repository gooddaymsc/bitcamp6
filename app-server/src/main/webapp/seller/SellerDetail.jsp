...
<form action='update'>
  ...
  <div class="col-sm-6">
    <input id='f-password' type='password' name='password' class="form-control" value='${seller.member.password}'><br>
      </div>
</div>
    <div class="mb-3 row">
  ...
  <div class="col-sm-10">
    <input id='f-phoneNumber' type='tel' name='phoneNumber' class="form-control" value='${seller.member.phoneNumber}'><br>
      </div>
</div>
  <div class="mb-3 row">
    <label for='f-businessName' class="col-sm-2 col-form-label">가게명</label>  
      <div class="col-sm-6">
         <input id='f-businessName' type='text' name='businessName' class="form-control" value='${seller.businessName}'><br>
      </div>
  </div>
    <div class="mb-3 row">
    <label for='f-businessNumber' class="col-sm-2 col-form-label">사업자번호</label>  
      <div class="col-sm-10">
    <input id='f-businessNumber' type='text' name='businessNumber' class="form-control" value='${seller.businessNumber}'><br>
          </div>
  </div>
    <div class="mb-3 row">
    <label for='f-businessAddress' class="col-sm-2 col-form-label">사업장주소</label>  
      <div class="col-sm-10">
    <input id='f-businessAddress' type='text' name='businessAddress' class="form-control" value='${seller.businessAddress}'><br>
          </div>
  </div>
    <div class="mb-3 row">
    <label for='f-businessPlaceNumber' class="col-sm-2 col-form-label">사업장번호</label>  
      <div class="col-sm-10">
    <input id='f-businessPlaceNumber' type='text' name='businessPlaceNumber' class="form-control" value='${seller.businessPlaceNumber}'><br>
          </div>
  </div>
    <div class="mb-3 row">
    <label for='f-businessOpeningTime' class="col-sm-2 col-form-label">오픈시간</label>  
      <div class="col-sm-6">
    <input id='f-businessOpeningTime' type='text' name='businessOpeningTime'class="form-control" value='${seller.businessOpeningTime}'><br>
          </div>
  </div>
    <div class="mb-3 row">
    <label for='f-businessClosingTime' class="col-sm-2 col-form-label">마감시간</label>  
    <div class="col-sm-6">
    <input id='f-businessClosingTime' type='text' name='businessClosingTime' class="form-control" value='${seller.businessClosingTime}'><br>
          </div>
  </div>
   <div class="mb-3 row">
    <label for='f-authority' class="col-sm-2 col-form-label">권한</label> 
      <div class="col-sm-6">
    <input id='f-authority' type='text' name='authority' class="form-control" value='${seller.member.authority}' readonly><br>
      </div>
  </div>
  <div class="mb-3 row">
