...
var content = '<div class="wrap">' + 
         ...
         '           </div>' + 
         '            <div class="desc">' + 
         '                <div class="ellipsis">서울시 강남구 역삼동 100</div>' + 
         '                <div><a href="../stock/list?id=seller22" target="_blank" class="link">스토어로이동</a></div>' + 
         '            </div>' + 
         '        </div>' + 
         '    </div>' +    
         '</div>';
...
/* function move_stock(no){
	 var xhr = new XMLHttpRequest();
	  xhr.addEventListener("load", function() {
	location.href='../stock/list?no='+ no;
});
 */
