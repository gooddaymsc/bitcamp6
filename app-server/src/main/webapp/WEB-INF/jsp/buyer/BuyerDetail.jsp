...
<%--       <div class="mb-3 row">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-6">
          <a href="${contextPath}/upload/buyer/${buyer.member.photo}" >
            <img id="f-photo-image" src="${contextPath}/upload/buyer/${buyer.member.photo}_100x100.jpg" onError="this.src='${contextPath}/upload/buyer/profile.png'" 
