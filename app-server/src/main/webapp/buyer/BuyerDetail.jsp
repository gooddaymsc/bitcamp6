...
<form action='update'>
  <div class="mb-3 row">
    <label for='f-no' class="col-sm-2 col-form-label">번호</label> 
     <div class="col-sm-6">
        <input id='f-no' type='text' name='number' class="form-control" value='${buyer.member.number}' readonly><br>
     </div>
  </div>
    <div class="mb-3 row">
  ...
  <div class="col-sm-6">
    <input id='f-password' type='password' name='password' class="form-control" value='${buyer.member.password}'><br>
      </div>
</div>
    <div class="mb-3 row">
  ...
  <div class="col-sm-10">
		<input id='f-phoneNumber' type='tel' name='phoneNumber' class="form-control" value='${buyer.member.phoneNumber}'><br>
		  </div>
</div>
		<div class="mb-3 row">
  ...
  <div class="col-sm-10">
		<input id='f-detailAddress' type='text' name='detailAddress' class="form-control" value='${buyer.detailAddress}'><br>
  </div>
</div>
    <div class="mb-3 row">
    <label for='f-authority' class="col-sm-2 col-form-label">권한</label> 
  <div class="col-sm-6">
    <input id='f-authority' type='text' name='authority' class="form-control" value='${buyer.member.authority}' readonly><br>
      </div>
</div>
    <div class="mb-3 row">
