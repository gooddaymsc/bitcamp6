  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    try {
      ...
      if (product == null) {
        ...
        //        out.printf("<label for='f-type'>주종</label> <input id='f-type' type='text' name='type' value='%d'><br>\n", product.getProductType().getType());
        //        out.printf("<label for='f-subType'>상세주종</label> <input id='f-subType' type='text' name='subType' value='%d'><br>\n", product.getProductType().getSubType());
        ...
        out.printf("<label for='f-variety'>품종</label> <input id='f-variety' type='volume' name='variety' value='%s'><br>\n", product.getVariety());
        out.printf("<label for='f-volume'>용량</label> <input id='f-volume' type='volume' name='volume'><br>\n", product.getVolume());
